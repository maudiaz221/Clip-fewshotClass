...
def pre_process(image_processor):
    ...
    train_transforms = Compose(
            [
                ...
                ToTensor(),
                normalize,
                RandomVerticalFlip(),  # New transformation: randomly flips the image vertically
                RandomRotation(degrees=10),  # New transformation: randomly rotates the image by up to 10 degrees
                RandomAffine(degrees=0, translate=(0.1, 0.1), scale=(0.9, 1.1)),  # New transformation: randomly applies affine transformation with translation and scale
