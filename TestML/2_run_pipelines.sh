...
python train.py -d "resources/Data - Is Epic Intro 2024-03-25" -l "Labels-IsEpicIntro-2024-03-25.csv" -t "Is Epic" -o "resources/Is Epic/"


python train.py -d "resources/Data - Is Epic Intro 2024-03-25" -l "Labels-IsEpicIntro-2024-03-25.csv" -t "Is Epic" -o "resources/Is Epic/"

python train.py -d "../evaluation/train" -l "Labels-IsEpicIntro-2024-03-25.csv"  -t "food" -o "resources/models/"
python predict.py -d "resources/sample_test_images" -l "Is Epic Files.txt" -t "food" -m "resources/models" -o "resources/food1.csv"
python predict.py -d "resources/sample_test_images" -l "Is Epic Files.txt" -t "food" -m "resources/models" -o "resources/food2.csv"
python predict.py -d "resources/sample_test_images" -l "Is Epic Files.txt" -t "food" -m "resources/models" -o "resources/food3.csv"
python predict.py -d "resources/sample_test_images" -l "Is Epic Files.txt" -t "food" -m "resources/models" -o "resources/food4.csv"
python predict.py -d "resources/sample_test_images" -l "Is Epic Files.txt" -t "food" -m "resources/models" -o "resources/food5.csv"

python predict.py -d "resources/sample_test_images" -l "Is Epic Files.txt" -t "food" -m "resources/models" -o "resources/food"
